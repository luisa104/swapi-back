...
from .mutations import AddUpdatePlanetMutation, AddUpdatePeopleMutation
...
class Mutation(graphene.ObjectType):
    add_update_planet_mutation = AddUpdatePlanetMutation.Field()
    add_update_people_mutation = AddUpdatePeopleMutation.Field()
