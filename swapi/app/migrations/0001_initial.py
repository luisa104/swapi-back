# Generated by Django 2.2.13 on 2022-04-10 22:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair_color', models.CharField(blank=True, choices=[('black', 'BLACK'), ('brown', 'BROWN'), ('blonde', 'BLONDE'), ('red', 'RED'), ('white', 'WHITE'), ('bald', 'BALD')], max_length=32)),
                ('skin_color', models.CharField(blank=True, max_length=32)),
                ('eye_color', models.CharField(blank=True, choices=[('black', 'BLACK'), ('brown', 'BROWN'), ('yellow', 'YELLOW'), ('red', 'RED'), ('green', 'GREEN'), ('purple', 'PURPLE'), ('unknown', 'UNKNOWN')], max_length=32)),
